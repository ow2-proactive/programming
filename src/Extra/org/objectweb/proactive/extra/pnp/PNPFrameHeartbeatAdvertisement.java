...
import org.objectweb.proactive.extra.pnp.exception.PNPMalformedMessageException;
...
class PNPFrameHeartbeatAdvertisement extends PNPFrame {
    ...
    public ChannelBuffer toChannelBuffer() {
        ...
        TypeHelper.longToByteArray(this.heartbeatPeriod, header, PNPFrame.Field.getTotalOffset() +
            Field.HEARTHBEAT_PERIOD.getOffset());
