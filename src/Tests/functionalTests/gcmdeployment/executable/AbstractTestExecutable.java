...
public class AbstractTestExecutable extends GCMFunctionalTest {
    ...
    public AbstractTestExecutable(Instances instances) {
        super(AbstractTestExecutable.class.getResource("TestExecutable.xml"));
