...
public interface AfterBlockingInterceptor extends DummyController, Interceptor {
    public static final String AFTER_BLOCKING_INTERCEPTOR_NAME = "after-blocking-interceptor-controller-controller";
}
