...
public class FunctionalComponent implements Service, BindingController {
    ...
    public String notify(String message) {
        String res = "FunctionalComponent>" + message;

        if (this.nonFunctionalComponent != null) {
            res = this.nonFunctionalComponent.notify(res);
        }
    ...
    public void bindFc(String clientItfName, Object serverItf) throws NoSuchInterfaceException {
        if (clientItfName.equals(NON_FUNCTIONAL_ITF_NAME)) {
            this.nonFunctionalComponent = (Service) serverItf;
        } else {
