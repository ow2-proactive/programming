 ...
 * can only takes a predefined selector as parameter, this class allow to pass a custom
 * selector
 * 
...
public class FastSelector {
     ...
     * Traverses a file.
     */
    private static void traverse(final FileSelectInfo fileInfo, final FastFileSelector selector,
