...
public class VMMHyperVWinRMParser extends AbstractVMMParser {

    static final String NODE_NAME = "hyperv-winrm";
    ...
    public void initializeGCMVirtualMachineManager(Node vmmNode, XPath xpath, GCMVirtualMachineManager gcmVMM)
        ...
        try {
            ...
            for (String uri : gcmVMM.getUris()) {
                gcmVMM.addVirtualMachineManager(new HyperVVMMWinRMBean(uri, user, pwd));
            }
        } catch (Exception e) {
