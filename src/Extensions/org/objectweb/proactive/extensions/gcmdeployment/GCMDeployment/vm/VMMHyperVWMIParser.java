...
public class VMMHyperVWMIParser extends AbstractVMMParser {

    static final String NODE_NAME = "hyperv-wmi";
    ...
    public void initializeGCMVirtualMachineManager(Node vmmNode, XPath xpath, GCMVirtualMachineManager gcmVMM)
        ...
        try {
            ...
            for (String uri : gcmVMM.getUris()) {
                gcmVMM.addVirtualMachineManager(new HyperVVMMWMIBean(uri, user, pwd));
            }
        } catch (Exception e) {
