 ...
 */
public enum PAADLErrors implements ErrorTemplate {

    /** Error template used when an error related to an executor service occurs. */
    EXECUTOR_ERROR("Executor service error: %s", "detail");
    ...
    private PAADLErrors(final String format, final Object... args) {
        this.id = ordinal();
        this.format = format;
