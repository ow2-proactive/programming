...
public interface ProActiveDescriptorInternal extends ProActiveDescriptor {
     ...
     */
    public void addProcessToSequenceList(AbstractSequentialListProcessDecorator sequentialListProcess, String string);
     ...
     * @param string a processID
     */
    public void addServiceToSequenceList(AbstractSequentialListProcessDecorator sequentialListProcess, String string);
