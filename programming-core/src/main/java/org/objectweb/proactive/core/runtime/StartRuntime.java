...
public class StartRuntime {
    ...
    private void register(ProActiveRuntime PART) {
        try {
            ProActiveRuntime proActiveRuntime = RuntimeFactory.getProtocolSpecificRuntime(CentralPAPropertyRepository.PA_COMMUNICATION_PROTOCOL.getValue());

            PART.register(proActiveRuntime,
