...
public abstract class AbstractRemoteObjectFactory implements RemoteObjectFactory {
    ...
    public static synchronized RemoteObjectFactory getRemoteObjectFactory(String protocol)
        ...
        try {
            ...
            throw new UnknownProtocolException("Failed to instanciate remote object factory for " + protocol, e);
        }

        throw new UnknownProtocolException("There is no RemoteObjectFactory defined for the protocol : " + protocol);
    }
