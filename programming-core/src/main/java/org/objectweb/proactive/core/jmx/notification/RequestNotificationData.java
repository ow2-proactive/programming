...
public class RequestNotificationData implements Serializable {
     ...
     */
    public RequestNotificationData(UniqueID source, String sourceNode, UniqueID destination, String destinationNode,
            String methodName, int requestQueueLength, long sequenceNumber, String tags) {
        this.source = source;
