...
public class RefactorPAD {
     ...
     * @throws IOException
     */
    private static ProActiveDescriptorInternal makeDeepCopy(ProActiveDescriptorInternal pad) throws IOException {
     ...
     * @throws IOException
     */
    public static ProActiveDescriptorInternal buildNoMainPAD(ProActiveDescriptorInternal pad) throws IOException {
