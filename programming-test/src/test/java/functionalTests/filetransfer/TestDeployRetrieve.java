...
public class TestDeployRetrieve extends FunctionalTest {
    ...
    static {
        try {
            XML_LOCATION = new File(TestAPI.class.getResource("/functionalTests/filetransfer/TestDeployRetrieve.xml")
                                                 .toURI());
    ...
    public void action() throws Exception {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Deployed " + node.length + " node from GCMVirtualNode " + testVNode.getName() + " in " +
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Retrieved " + list.size() + " files from GCMVirtualNode " + testVNode.getName() + " in " +
