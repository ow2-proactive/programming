...
public class GCMFunctionalDataSpacesBase extends GCMFunctionalTest {
    ...
    static final private URL dataSpacesApplicationDescriptor = FunctionalTest.class.getResource("/functionalTests/dataspaces/JunitAppDataSpaces.xml");
    ...
    public GCMFunctionalDataSpacesBase(int hostCapacity, int vmCapacity) throws IOException {
        ...
        vc.setVariableFromProgram(VAR_HOSTCAPACITY,
                                  Integer.valueOf(hostCapacity).toString(),
                                  VariableContractType.DescriptorDefaultVariable);
        vc.setVariableFromProgram(VAR_VMCAPACITY,
                                  Integer.valueOf(vmCapacity).toString(),
                                  VariableContractType.DescriptorDefaultVariable);
        ...
        vc.setVariableFromProgram(VAR_INPUT_DEFAULT_WITH_DIR_URL,
                                  getRootSubdirURL(inputDefaultWithDirLocalHandle),
                                  VariableContractType.ProgramVariable);
        vc.setVariableFromProgram(VAR_INPUT_WITH_DIR_URL,
                                  getRootSubdirURL(inputWithDirLocalHandle),
                                  VariableContractType.ProgramVariable);
        vc.setVariableFromProgram(VAR_INPUT_WITH_FILE_URL,
                                  getRootSubdirURL(inputWithFileLocalHandle),
                                  VariableContractType.ProgramVariable);
        vc.setVariableFromProgram(VAR_OUTPUT_DEFAULT_WITH_DIR_URL,
                                  getRootSubdirURL(outputDefaultWithDirLocalHandle),
                                  VariableContractType.ProgramVariable);
        vc.setVariableFromProgram(VAR_OUTPUT_WITH_DIR_URL,
                                  getRootSubdirURL(outputWithDirLocalHandle),
                                  VariableContractType.ProgramVariable);
        vc.setVariableFromProgram(VAR_OUTPUT_WITH_FILE_URL,
                                  getRootSubdirURL(outputWithFileLocalHandle),
                                  VariableContractType.ProgramVariable);
        vc.setVariableFromProgram(VAR_OUTPUT_WITH_NOTHING1_URL,
                                  getRootSubdirURL(outputWithNothing1LocalHandle),
                                  VariableContractType.ProgramVariable);
        vc.setVariableFromProgram(VAR_OUTPUT_WITH_NOTHING2_URL,
                                  getRootSubdirURL(outputWithNothing2LocalHandle),
                                  VariableContractType.ProgramVariable);
    ...
    public void tryStartFileSystemServer() throws IOException {
        if (fileSystemServerDeployer == null) {
            ...
            fileSystemServerDeployer = new FileSystemServerDeployer("ProActive-GCMFunctionalDataSpacesBase/fileSystemServer",
