...
public class DumpPeersimFileChooserAction implements IWorkbenchWindowActionDelegate {
    ...
    public void run(IAction action) {
        ...
        fd.setText("Open PeerSim dump file");
        String filename = fd.open();
        if (filename != null) {
            // loadImage(filename);
            //         String currentDir = fd.getFilterPath();
            System.out.println("Opening peersim " + filename);
            P2PView.loadPeersimDumpFile(filename);
        }
    }
