...
public class OSRuntime {
     ...
     *             {@link ProcessBuilder}
     */
    public Process exec(OSUser user, CoreBindingDescriptor cores, String[] command, Map<String, String> envp, File dir)
     ...
     *             {@link ProcessBuilder}
     */
    public Process exec(String[] command, Map<String, String> envp, File dir)
            throws IOException, FatalProcessBuilderException {
