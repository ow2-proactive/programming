...
public class CleanupTimeoutGetter {
    ...
    private static final String SECONDS_TASK_CLEANUP_TIMEOUT_PROP_NAME = "proactive.process.builder.cleanup.time.seconds";
    ...
    public long getCleanupTimeSeconds() {
        try {
            ...
            LOGGER.warn("proactive.task.cleanup.time: " + System.getProperty(SECONDS_TASK_CLEANUP_TIMEOUT_PROP_NAME) +
