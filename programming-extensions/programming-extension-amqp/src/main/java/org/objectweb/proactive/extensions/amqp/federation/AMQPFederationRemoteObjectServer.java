...
public class AMQPFederationRemoteObjectServer extends AbstractAMQPRemoteObjectServer {
    ...
    public AMQPFederationRemoteObjectServer(InternalRemoteRemoteObject rro) throws IOException, ProActiveException {
        super(rro);
    ...
    protected void createObjectQueue(Channel channel, String queueName) throws IOException {
        ...
        channel.queueBind(queueName, AMQPFederationConfig.PA_AMQP_FEDERATION_RPC_EXCHANGE_NAME.getValue(), queueName);
    }
