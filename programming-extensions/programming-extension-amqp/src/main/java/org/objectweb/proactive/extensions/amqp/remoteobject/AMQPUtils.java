...
public class AMQPUtils {
    ...
    static {
        ...
        if (AMQPConfig.PA_AMQP_SOCKET_FACTORY.isSet() && "ssh".equals(AMQPConfig.PA_AMQP_SOCKET_FACTORY.getValue())) {
            socketFactory = new SshTunnelSocketFactory(AMQPConfig.PA_AMQP_SSH_KEY_DIR,
                                                       AMQPConfig.PA_AMQP_SSH_KNOWN_HOSTS,
                                                       AMQPConfig.PA_AMQP_SSH_REMOTE_PORT,
