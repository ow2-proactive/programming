...
public class BaseScratchSpaceConfiguration implements Serializable {
     ...
     */
    public BaseScratchSpaceConfiguration(final String[] urls, final String path) throws ConfigurationException {
        this.path = path;
     ...
     */
    public BaseScratchSpaceConfiguration getWithRemoteAccess(final String[] urls) throws ConfigurationException {
