...
public class InputOutputSpaceConfiguration extends SpaceConfiguration {
     ...
     */
    public static InputOutputSpaceConfiguration createInputSpaceConfiguration(String url, String path, String hostname,
     ...
     *             hostname for path, wrong space type)
     */
    public static InputOutputSpaceConfiguration createOutputSpaceConfiguration(String url, String path, String hostname,
            String name) throws ConfigurationException {

        return new InputOutputSpaceConfiguration(url, path, hostname, SpaceType.OUTPUT, name);
    }

    public static InputOutputSpaceConfiguration createOutputSpaceConfiguration(List<String> urls, String path,
            String hostname, String name) throws ConfigurationException {
    ...
    public static InputOutputSpaceConfiguration createConfiguration(List<String> urls, String path, String hostname,
            String name, SpaceType spaceType) throws ConfigurationException {
